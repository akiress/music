...
Benjamin Guitreau\\
       ...
       \affaddr{340 East Parker Boulevard}\\
...
Links to URLs can be included using the \texttt{{\char'134}url} command. This will generate a clickable link like this: \url{http://www.nime2013.org}.
